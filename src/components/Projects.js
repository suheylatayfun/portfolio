    ...
    <div className="projects-container" id="projects">
        ...
        <div className="project">
          ...
          <div className="project-info">
            <p><strong>Volevent</strong>, personal project, is a fully responsive volunteering website that brings volunteers and organizations together on volunteering events. Organizations can share their events which are serving the community and  in need of volunteers and Volunteers can check for upcoming events and be a volunteer in them.
        ...
        <div className="project">
          ...
          <div className="project-info">
            <p><strong>Gift Away</strong>, group project, is a fully responsive donation website that helps users to give away his/her unused or unwanted items at home. Donators can easily share their stuff. Donation takers can view donations they wish and chat with donators to schedule a time for picking up donation/s. 
        ...
        <div className="project">
          ...
          <div className="project-info">
            <p><strong>Storepo</strong> is a blog hosting platform for user to share their first day experience at work with others. Users also can view others' experience and search blogs under different categories.
