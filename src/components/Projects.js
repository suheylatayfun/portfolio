  ...
  return (
    <div className="projects-container" id="projects">
      ...
      <div className="project">
        ...
        <div className="project-info">
          <p>
            ...
            Donation takers can view donations they wish and chat with donators
            to schedule a time for picking up donation/s.
            <p>
              <strong>Technologies:</strong> React, Redux, Node, Express,
      ...
      <div className="project">
        ...
        <div className="project-info">
          <p>
            <strong>My recipe book</strong> is a clean and simple react app that
            helps you to easily keep your recipes organized. It was built with
            React with users' adding, viewing, updating, and deleting his/her
            recipe functionalities. All recipe data was stored in postgresql
            database.
            <p>
